...
\coordinate (p12) at (\r/2-3.75,\r/4/sqrt 2);
...
\draw[decorate,black] (ab1cd) to[in=245, out=100] (cd1ab);

\draw[decorate,black] (bd1ac) to[in=10,out=225] (ac1bd);

\draw[decorate,black] (ad1bc) to[in=125,out=330] (bc1ad);
